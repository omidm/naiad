...
public class LogisticRegression
{
  ...
  public static Stream<Sample, IterationIn<Epoch>> Operate(Stream<Sample, IterationIn<Epoch>> x)
  {
  ...
  public static IEnumerable<Sample> GenerateNodes(int dimension, int counts, int seed)
  {
